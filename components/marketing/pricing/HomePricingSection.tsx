      ...
      <div className="mt-14 grid gap-6 lg:grid-cols-3 lg:gap-8">
        {content.pricing.plans.map((plan, index) => (
          <article
            key={plan.name}
            className={cn(
              "flex h-full flex-col rounded-[var(--marketing-radius-xl)] bg-[var(--marketing-elevated-surface)] p-7 shadow-[var(--marketing-shadow-soft)] ring-1 ring-[var(--marketing-border-default)] sm:p-8",
