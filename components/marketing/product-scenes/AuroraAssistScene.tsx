          ...
          <SceneMotionLayer delay={450}>
            <ScenePanel padding="compact" className={sceneStyles.primarySurface} title={locale === "id" ? "Draft & approval" : "Draft & approval"}>
              ...
              <div className="mt-3 space-y-1.5">
                <StaticControl label={copy.aurora.reviewDraft} delay={750} />
                <StaticControl label={copy.aurora.editResponse} delay={830} />
                <StaticControl label={copy.aurora.approveSend} emphasis delay={910} />
              </div>
              <SceneMotionLayer delay={1000}>
