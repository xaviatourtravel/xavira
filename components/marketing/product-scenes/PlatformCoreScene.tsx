...
const MODULES = [
  { id: "communication", icon: MessageSquare, col: "1 / 2", row: "1" },
  { id: "crm", icon: Users, col: "2 / 3", row: "1" },
  { id: "operations", icon: LayoutGrid, col: "4 / 5", row: "1" },
  { id: "finance", icon: CreditCard, col: "5 / 6", row: "1" },
  { id: "automation", icon: Workflow, col: "1 / 2", row: "2" },
  { id: "aurora", icon: Bot, col: "2 / 3", row: "2" },
  { id: "analytics", icon: BarChart3, col: "5 / 6", row: "2" },
] as const;
      ...
      <div className={cn(sceneStyles.canvas, "relative m-2 p-3 sm:m-3 sm:p-4")}>
        <div className="relative grid min-h-[360px] grid-cols-2 gap-2 sm:min-h-[400px] md:grid-cols-5 md:grid-rows-[1fr_auto] md:gap-3">
          <svg
            ...
            aria-hidden
          >
            <line x1="50%" y1="28%" x2="20%" y2="18%" stroke="currentColor" strokeWidth="1" strokeDasharray="4 3" opacity="0.6" />
            <line x1="50%" y1="28%" x2="36%" y2="18%" stroke="currentColor" strokeWidth="1" strokeDasharray="4 3" opacity="0.6" />
            <line x1="50%" y1="28%" x2="64%" y2="18%" stroke="currentColor" strokeWidth="1" strokeDasharray="4 3" opacity="0.6" />
            <line x1="50%" y1="28%" x2="80%" y2="18%" stroke="currentColor" strokeWidth="1" strokeDasharray="4 3" opacity="0.6" />
            <line x1="50%" y1="28%" x2="50%" y2="72%" stroke="currentColor" strokeWidth="1.5" strokeDasharray="4 3" opacity="0.75" />
          </svg>
          ...
          <div className="relative z-[2] col-span-2 flex items-center justify-center md:col-span-1 md:col-start-3 md:row-start-1 md:row-end-2">
          ...
          <ScenePanel
            ...
            title={locale === "id" ? "Timeline bersama" : "Shared timeline"}
          >
