...
Every workspace opens directly into work.
...
Today's workspace should fit within one viewport.

Scrolling means prioritization failed.

Users should immediately know where to start.
...
Users should not navigate to find work.
