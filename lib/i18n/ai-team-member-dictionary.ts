export type AiTeamMemberUiDictionary = {
  ...
  callCheckingBrain: string;
  callSearchingWeb: string;
  callAnalyzing: string;
  callCheckingMemory: string;
  evidenceBrain: string;
  evidenceWeb: string;
...
export const aiTeamMemberUiId: AiTeamMemberUiDictionary = {
  ...
  callCheckingBrain: "Mengecek Business Brain…",
  callSearchingWeb: "Mencari informasi terbaru…",
  callAnalyzing: "Menganalisis…",
  callCheckingMemory: "Mengecek data…",
  evidenceBrain: "Business Brain",
  evidenceWeb: "Web",
  evidenceAnalysis: "Analisis AI",
  evidenceMemory: "Memori",
};
...
export const aiTeamMemberUiEn: AiTeamMemberUiDictionary = {
  ...
  realtimeTranscriptSource: "Voice Call",
  callCheckingBrain: "Checking Business Brain…",
  callSearchingWeb: "Searching for latest info…",
  callAnalyzing: "Analyzing…",
  callCheckingMemory: "Checking data…",
  evidenceBrain: "Business Brain",
  evidenceWeb: "Web",
  evidenceAnalysis: "AI analysis",
